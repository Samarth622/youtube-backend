...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
        {
            $match: {
                username: username, // this pipeline is used to find username in database
            },
        },
        {
            $lookup: {
                // this pipeline is used to join channel with user
                from: "subscriptions",
                localField: "_id",
        ...
        {
            $lookup: {
                // this pipeline is used to join user with channel
                from: "subscriptions",
                localField: "_id",
        ...
        {
            $project: {
                // this pipeline is used to return document with given fields to next document
                fullName: 1,
                username: 1,
                subscribersCount: 1,
